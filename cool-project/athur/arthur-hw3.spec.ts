...
import {
    ...
    priceText,
    prices,
} from '../athur/page-object/locators';
...
test.describe('Comp&Parts testing', () => {
    test('Get AM4 CPU', async ({ page }) => {
        ...
        await page.locator(carouselCategory, { hasText: 'Computer Components & Parts' }).click();
        ...
        // fix expect to check real value
        expect(getPrice[0]).toBe('453$');
    });
});
