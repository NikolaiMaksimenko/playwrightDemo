...
test.describe('Comp&Parts testing', () => {
    test('Get AM4 CPU', async ({ page }) => {
        ...
        await page
            .locator('[class=b-guidancecard__title]', { hasText: 'Computer Components & Parts' })
            .click();
        ...
        const priceText = (await page.$$('[class="s-item__price"]'))[0];
        const getFirstItemPrice = (await priceText.textContent()).toString();

        expect(getFirstItemPrice).toBe('$256.00');
    });
});
